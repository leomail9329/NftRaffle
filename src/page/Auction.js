...
import idl from "../assets/anchor_nft_auction.json"
const { Meta } = Card;
        ...
        <div style={{ marginTop: '100px', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div style={{ background: 'white', borderRadius: '70px', padding: '0px', display: 'flex', alignItems: 'center' }}>
                    <span style={{ fontSize: '20px', fontFamily: 'font1', color: 'grey', margin: '0px 50px 0px 50px', cursor: 'pointer' }} onClick={gotoRaffle}>
                        RAFFLE
                    </span>
